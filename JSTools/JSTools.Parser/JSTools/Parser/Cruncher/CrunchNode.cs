...
{
	/// <summary>
	/// Summary description for CrunchNode.
	/// </summary>
	public class CrunchNode : GlobalNode
	{
		//------------------------------------------------------------------------------------------
		// Declarations
		//------------------------------------------------------------------------------------------
		...
		/// <summary>
		/// Creates a new CrunchNode object.
		/// </summary>
		/// <param name="parseItemName">Name of the representing parse item.</param>
		public CrunchNode(string parseItemName) : base(parseItemName)
		{
		}
		...
		public virtual string ToCrunchString()
		{
			return ParsedCode;
		}
	}

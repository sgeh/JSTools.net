...
{
	/// <summary>
	/// Represents an immutalbe instance of the &lt;scripts&gt; configuration section in the
	/// JSTools.net configuration.
	/// </summary>
	public class JSScriptFileHandler : AJSScriptFileHandler
	{
		//------------------------------------------------------------------------------------------
		// Declarations
		//------------------------------------------------------------------------------------------
		...
		{
			get { return _debug; }
			set { WriteableInstance.Debug = value; }
		}
		...
		public override string ScriptType
		{
			...
			set { WriteableInstance.ScriptType = value; }
		}
		...
		public override double ScriptVersion
		{
			...
			set { WriteableInstance.ScriptVersion = value; }
		}
		...
		public override string DebugScriptSource
		{
			...
			set { WriteableInstance.DebugScriptSource = value; }
		}
		...
		{
			get { return _debugScriptSource; }
			set { WriteableInstance.ReleaseScriptSource = value; }
		}
		...
		public JSScriptFileHandler(XmlNode section, string nodeName) : base(section, nodeName)
		{
		}

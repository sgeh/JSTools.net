...
namespace JSTools.Test.Resources
{
	/// <summary>
	...
	public class Settings
	{
		...
		private Settings()
		{
			_resources = new ResourceManager(typeof(Settings));
		}
		...
		{
			get { return Path.GetFullPath(GetString("ConfigFilePath")); }
		}
		...
		{
			get { return Path.GetFullPath(GetString("ConfigSavePath")); }
		}
		...
		{
			get { return Path.GetFullPath(GetString("CrunchFilePath")); }
		}

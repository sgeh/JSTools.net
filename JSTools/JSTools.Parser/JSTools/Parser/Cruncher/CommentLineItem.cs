...
namespace JSTools.Parser.Cruncher
{
	...
	/// </summary>
	public class CommentLineItem : IParseItem
	{
		//--------------------------------------------------------------------
		// Declarations
		//--------------------------------------------------------------------

		public	const string	ITEM_NAME		= "Comment Line Item";
		...
		/// <summary>
		/// Creates a new CommentLineItem instance.
		/// </summary>
		public CommentLineItem()
		{
		}
		...
		public bool End(INode parentNode, string parseString, int index)
		{
			return (parseString[index] == '\n' || parseString[index] == '\r'
				|| parseString[index] == (char)0x2028 || parseString[index] == (char)0x2029);
		}

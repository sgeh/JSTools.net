...
namespace JSTools.Parser
{
	...
	/// </summary>
	public class CommentNode : DefaultNode
	{
		//--------------------------------------------------------------------
		// Declarations
		//--------------------------------------------------------------------
		...
		/// <summary>
		/// Gets the xml comment of the parsed code lines.
		/// </summary>
		internal string XmlComment
		{
			get 
			{
				...
				foreach (INode childNode in Children)
				{
					...
					string parsedCode = childNode.ParsedCode;

					if (parsedCode.StartsWith(COMMENT_START))
						xmlComment.Append(parsedCode, COMMENT_START.Length, parsedCode.Length - COMMENT_START.Length);
					else
						xmlComment.Append(parsedCode);
				}

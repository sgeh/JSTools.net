...
namespace JSTools.Parser.Cruncher
{
	...
	/// </summary>
	public class UnnecessaryStaticItem : IParseItem
	{
		//--------------------------------------------------------------------
		// Declarations
		//--------------------------------------------------------------------

		public	const			string	ITEM_NAME		= "Unnecessary Static White Space Item";
		...
		/// <summary>
		/// Creates a new UnnecessaryStaticItem instance.
		/// </summary>
		public UnnecessaryStaticItem()
		{
		}
		...
		public bool Begin(INode parentNode, string parseString, int index)
		{
			...
			if (Cruncher.IsSeparator(parseString[index - 1]))
				return true;

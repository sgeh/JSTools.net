...
namespace JSTools.Parser
{
	...
	/// <c>/// &lt;example&gt;...</c>
	/// </summary>
	internal class SingleLineCommentItem : AParseItem
	{
		//--------------------------------------------------------------------
		// Declarations
		//--------------------------------------------------------------------
		...
		/// <summary>
		/// Creates a new SingleLineCommentItem instance.
		/// </summary>
		/// <param name="itemName">Name of the item.</param>
		internal SingleLineCommentItem(string itemName) : base(itemName)
		{
		}

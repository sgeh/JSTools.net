...
{
	/// <summary>
	/// Represents a multi line comment item, which holds strings like "/*...\n...\n...*/".
	/// </summary>
	public class CommentMultiLineItem : IParseItem
	{
		//--------------------------------------------------------------------
		// Declarations
		//--------------------------------------------------------------------

		public	const string	ITEM_NAME		= "Comment Multi Line Item";
		...
		/// <summary>
		/// Creates a new CommentMultiLineItem instance.
		/// </summary>
		public CommentMultiLineItem()
		{
		}
		...
		{
			return (index + 1 < parseString.Length &&
				parseString[index] == '/' &&
				parseString[index + 1] == '*');
		}
		...
		{
			return (index > 0 && parseString[index - 1] == '*' && parseString[index] == '/');
		}

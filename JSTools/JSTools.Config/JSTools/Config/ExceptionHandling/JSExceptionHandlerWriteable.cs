...
{
	/// <summary>
	/// Represents an writeable JSExceptionHandling instance of the &lt;exception&gt; configuration section
	/// in the JSTools.net configuration.
	/// </summary>
	public class JSExceptionHandlerWriteable : AJSExceptionHandler
	{
		//------------------------------------------------------------------------------------------
		// Declarations
		//------------------------------------------------------------------------------------------
		...
		/// <summary>
		/// Initializes a new JSExceptionHandlingWriteable instance.
		/// </summary>
		...
		public JSExceptionHandlerWriteable(XmlNode exceptionNode, string nodeName) : base(exceptionNode, nodeName)
		{
		}

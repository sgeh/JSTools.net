...
{
	/// <summary>
	/// Contains an immutable &lt;file&gt; node implementation.
	/// </summary>
	public class JSScript : AJSScript
	{
		//------------------------------------------------------------------------------------------
		// Declarations
		//------------------------------------------------------------------------------------------
		...
		{
			get { return _code; }
			set { WriteableInstance.CommentCode = value; }
		}
		...
		public override string FileName
		{
			...
			set { WriteableInstance.FileName = value; }
		}
		...
		/// <summary>
		/// Creates a new immutable JSScript instance.
		/// </summary>
		...
		internal JSScript(XmlNode scriptNode, AJSScriptFileHandler ownerHandler) : base(scriptNode, ownerHandler)
		{
		}
		...
		/// <exception cref="ArgumentNullException">An argument contains a null reference.</exception>
		/// <exception cref="ArgumentException">A AJSScript with the given path is already imported.</exception>
		internal JSScript(string folder, XmlNode scriptNode, AJSScriptFileHandler ownerHandler) : base(folder, scriptNode, ownerHandler)
		{
		}

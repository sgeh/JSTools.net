/*
 * JSTools.net - A framework for JavaScript/ASP.NET applications.
...
(see licence.txt)! This means, that you can use the features in a commercial
environment too.

For more information about the project visit JSTools.net
(http://www.jstools.net). 

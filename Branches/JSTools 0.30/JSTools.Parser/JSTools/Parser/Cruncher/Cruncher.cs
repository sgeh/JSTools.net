...
namespace JSTools.Parser.Cruncher
{
	...
	public class Cruncher
	{
		...
		{
			if (toCrunch == String.Empty || toCrunch == null)
				return String.Empty;
		...
		/// <summary>
		/// Removes all the comments from the given script code and checks for syntax errors.
		/// </summary>
		/// <param name="toParse">Script code to remove the comments.</param>
